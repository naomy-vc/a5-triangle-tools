...
public final class Checker implements ActualParameterVisitor<FormalParameter, Void>,
	...
	@Override
	public Void visitDoubleCommand(DoubleCommand ast, Void arg) {
		var vType = ast.vname.visit(this);

		checkAndReportError(ast.vname.variable, "LHS of ** is not a variable", ast.vname);
		checkAndReportError(vType.equals(StdEnvironment.integerType),
		"The ** command only works on integers", ast);
